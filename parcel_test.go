...
func TestGetByClient(t *testing.T) {
	...
	require.Len(t, parcels, len(storedParcels))     // убедитесь, что количество полученных посылок совпадает с количеством добавленных
	...
	for _, parcel := range storedParcels {
		...
		//require.Equal(t, parcelMap, storedParcels)
